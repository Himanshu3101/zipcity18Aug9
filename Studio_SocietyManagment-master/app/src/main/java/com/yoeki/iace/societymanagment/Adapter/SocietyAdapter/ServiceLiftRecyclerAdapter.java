...
public class ServiceLiftRecyclerAdapter extends RecyclerView.Adapter<ServiceLiftRecyclerAdapter.ViewHolder> {
...
//    private ItemClickListener mClickListener;
    ...
    public ServiceLiftRecyclerAdapter(Lift_Info context, List<String> data) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        String lift = mData.get(position);
        String[] Liftdata = lift.split(",");
