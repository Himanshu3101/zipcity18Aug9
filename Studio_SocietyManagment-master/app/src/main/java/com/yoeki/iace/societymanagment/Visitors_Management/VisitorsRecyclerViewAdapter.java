...
public class VisitorsRecyclerViewAdapter extends RecyclerView.Adapter<VisitorsRecyclerViewAdapter.ViewHolder> {
...
//    private ItemClickListener mClickListener;
    ...
    VisitorsRecyclerViewAdapter(Context context, List<String> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.visitorsrecycler, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(Break[6].equalsIgnoreCase("null")|| Break[6].equalsIgnoreCase("") || Break[6].equalsIgnoreCase(" ")){
            ...
            if(Break[6].equals("Home")){
                holder.status_image.setImageResource(R.drawable.home);
            }else{
                holder.status_image.setImageResource(R.drawable.not_home);
            }
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        AppCompatImageView status_image;
